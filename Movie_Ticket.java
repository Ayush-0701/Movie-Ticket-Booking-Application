        ...
        try{
            ...
            while(true){
                ...
                if(rs.next()){
                    ...
                    pst1=con.prepareStatement("update movie set seat=? where id=?");
    ...
    public static void CancleTicket() throws SQLException{
        try{
            while(true){
                ...
                pst=con.prepareStatement("select * from movie where id=?");
                pst.setInt(1,Mid);
                rs=pst.executeQuery();
                if(rs.next()){
                    showMyTicket(num);
                    ...
                    PreparedStatement pst1=con.prepareStatement("update movie set seat=? where id=?");
